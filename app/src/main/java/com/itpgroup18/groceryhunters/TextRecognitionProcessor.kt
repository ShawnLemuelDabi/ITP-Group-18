...
import com.itpgroup18.groceryhunters.PreferenceUtils
import com.itpgroup18.groceryhunters.VisionProcessorBase
...
class TextRecognitionProcessor(private val context: Context, textRecognizerOptions: TextRecognizerOptionsInterface) : VisionProcessorBase<Text>(context) {
    ...
    companion object {
        ...
        var textDetected : MutableLiveData<Boolean> = MutableLiveData()
