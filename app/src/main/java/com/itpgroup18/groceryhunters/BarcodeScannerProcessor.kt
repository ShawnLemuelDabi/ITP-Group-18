...
class BarcodeScannerProcessor(context: Context) : VisionProcessorBase<List<Barcode>>(context) {
    ...
    override fun onSuccess(barcodes: List<Barcode>, graphicOverlay: GraphicOverlay) {
        if (barcodes.isEmpty()) {
            ...
            barcodeDetected.postValue(false)
        }
        for (i in barcodes.indices) {
            ...
            barcodeDisplayValue.postValue(barcode.displayValue)
            barcodeDetected.postValue(true)
        }
    }
    ...
    companion object {
        ...
        var barcodeDetected : MutableLiveData<Boolean> = MutableLiveData()
        var barcodeDisplayValue : MutableLiveData<String> = MutableLiveData()
